...
% Page layoutP
\usepackage[left=2.5cm,right=2.5cm,top=2.5cm,bottom=2.5cm]{geometry}P
...
\newcommand{\name}{Gerthardus M. Marais}
\newcommand{\studentnumber}{21642818}
\newcommand{\supervisor}{Dr. R. Theart}
